...
```{r organiseBehavData}
behavData <- read.table("F:/NP32019/Behaviour/BehavData.csv",header = TRUE, sep=",")
...
(ref:indvSubjChoice) Subtractracted ERPs showing the lateralized response contralateral to the side of the easy target as a function of easy set size.
